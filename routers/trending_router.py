...
# from database.models import TrendingData, TopApplication, TopRecipe
# import asyncio
...
#             SELECT 
#                 d.specific_category AS name,
#                 COUNT(DISTINCT d.dish_id) AS count
#             FROM 
...
#             name,
#             count,
#             ROUND((count * 100.0 / (SELECT total FROM total_count)), 1) AS proportion
#         FROM 
#             category_counts
#         ORDER BY 
#             count DESC
...
#         SELECT 
#             d.dish_name AS dish,
#             ROUND(CAST(d.star_rating AS DOUBLE), 1) AS avg_rating,
#             d.num_ratings,
#             d.source
#         FROM 
#             flavorlens.main.dishes d
...
#                     name=row["name"],
#                     count=int(row["count"]),
#                     growth=float(row["proportion"])  # Using proportion for the bar chart
#                 ))
...
#             if top_applications:
#                 categories = [app.name.split(' ')[-1] for app in top_applications]
